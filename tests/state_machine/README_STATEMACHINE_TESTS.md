...
#### 模块覆盖率详情:
- **src/state_machine/base.py**: 81% (核心状态机功能)
- **src/state_machine/task.py**: 93% (任务和树形节点)
- **src/state_machine/const.py**: 100% (常量定义)
- **src/state_machine/interface.py**: 69% (接口定义)
- **src/state_machine/builder.py**: 29% (构建器工厂)
