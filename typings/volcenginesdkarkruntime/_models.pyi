...
class BaseModel(pydantic.BaseModel):
    ...
    if not PYDANTIC_V2:
        @override
        def model_dump(self, *, mode: Literal["json", "python"] | str = ..., include: (set[int] | set[str] | dict[int, Any] | dict[str, Any] | None) = ..., exclude: (set[int] | set[str] | dict[int, Any] | dict[str, Any] | None) = ..., by_alias: bool = ..., exclude_unset: bool = ..., exclude_defaults: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., warnings: bool = ...) -> dict[str, Any]:
        ...
        @override
        def model_dump_json(self, *, indent: int | None = ..., include: (set[int] | set[str] | dict[int, Any] | dict[str, Any] | None) = ..., exclude: (set[int] | set[str] | dict[int, Any] | dict[str, Any] | None) = ..., by_alias: bool = ..., exclude_unset: bool = ..., exclude_defaults: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., warnings: bool = ...) -> str:
