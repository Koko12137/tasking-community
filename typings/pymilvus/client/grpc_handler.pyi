...
from . import utils
from .abstract import AnnSearchRequest, BaseRanker, CollectionSchema, FieldSchema
...
class GrpcHandler:
    ...
    def register_reconnect_handler(self, handler: ReconnectHandler): # -> None:
        ...
    ...
    def create_collection(self, collection_name: str, fields: Union[CollectionSchema, Dict[str, Iterable]], timeout: Optional[float] = ..., **kwargs): # -> None:
        ...
    ...
    @retry_on_rpc_failure()
    def add_collection_field(self, collection_name: str, field_schema: FieldSchema, timeout: Optional[float] = ..., **kwargs): # -> None:
        ...
    
    @retry_on_rpc_failure()
    def alter_collection_properties(self, collection_name: str, properties: List, timeout: Optional[float] = ..., **kwargs): # -> None:
        ...
    
    @retry_on_rpc_failure()
    def alter_collection_field_properties(self, collection_name: str, field_name: str, field_params: Dict[str, Any], timeout: Optional[float] = ..., **kwargs): # -> None:
        ...
    ...
    @retry_on_rpc_failure()
    def insert_rows(self, collection_name: str, entities: Union[Dict, List[Dict]], partition_name: Optional[str] = ..., schema: Optional[dict] = ..., timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any] | MutationResult:
        ...
    
    def update_schema(self, collection_name: str, timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
        ...
    ...
    @retry_on_rpc_failure()
    def upsert_rows(self, collection_name: str, entities: List, partition_name: Optional[str] = ..., timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any] | MutationResult:
        ...
    
    @retry_on_rpc_failure()
    def search(self, collection_name: str, data: Union[List[List[float]], utils.SparseMatrixInputType], anns_field: str, param: Dict, limit: int, expression: Optional[str] = ..., partition_names: Optional[List[str]] = ..., output_fields: Optional[List[str]] = ..., round_decimal: int = ..., timeout: Optional[float] = ..., ranker: Union[Function, FunctionScore] = ..., **kwargs): # -> SearchFuture | SearchResult:
        ...
    
    @retry_on_rpc_failure()
    def hybrid_search(self, collection_name: str, reqs: List[AnnSearchRequest], rerank: Union[BaseRanker, Function], limit: int, partition_names: Optional[List[str]] = ..., output_fields: Optional[List[str]] = ..., round_decimal: int = ..., timeout: Optional[float] = ..., **kwargs): # -> SearchFuture | SearchResult:
        ...
    
    @retry_on_rpc_failure()
    def get_query_segment_info(self, collection_name: str, timeout: float = ..., **kwargs) -> List[milvus_types.QuerySegmentInfo]:
        ...
    ...
    @retry_on_rpc_failure()
    def get_persistent_segment_infos(self, collection_name: str, timeout: Optional[float] = ..., **kwargs) -> List[milvus_types.PersistentSegmentInfo]:
        ...
    ...
    @retry_on_rpc_failure()
    def update_replicate_configuration(self, clusters: Optional[List[Dict]] = ..., cross_cluster_topology: Optional[List[Dict]] = ..., timeout: Optional[float] = ..., **kwargs):
        """
