...
def get_field_data(field_data: FieldData): # -> RepeatedScalarFieldContainer[bool] | RepeatedScalarFieldContainer[int] | RepeatedScalarFieldContainer[float] | RepeatedScalarFieldContainer[str] | RepeatedScalarFieldContainer[bytes] | RepeatedCompositeFieldContainer[ScalarField] | bytes | SparseFloatArray | StructArrayField | VectorArray:
    ...
