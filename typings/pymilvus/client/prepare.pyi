...
class Prepare:
    ...
    @staticmethod
    def get_field_schema(field: Dict, primary_field: Optional[str] = ..., auto_id_field: Optional[str] = ...) -> (schema_types.FieldSchema, Optional[str], Optional[str]):
        ...
    ...
    @classmethod
    def row_insert_param(cls, collection_name: str, entities: List, partition_name: str, fields_info: Dict, struct_fields_info: Optional[Dict] = ..., schema_timestamp: int = ..., enable_dynamic: bool = ...): # -> InsertRequest | UpsertRequest:
        ...
    
    @classmethod
    def row_upsert_param(cls, collection_name: str, entities: List, partition_name: str, fields_info: Any, struct_fields_info: Any = ..., enable_dynamic: bool = ..., schema_timestamp: int = ..., partial_update: bool = ...): # -> InsertRequest | UpsertRequest:
        ...
    ...
    @classmethod
    def batch_upsert_param(cls, collection_name: str, entities: List, partition_name: str, fields_info: Any, partial_update: bool = ...): # -> InsertRequest | UpsertRequest:
        ...
    ...
    @classmethod
    def search_requests_with_expr(cls, collection_name: str, data: Union[List, utils.SparseMatrixInputType], anns_field: str, param: Dict, limit: int, expr: Optional[str] = ..., partition_names: Optional[List[str]] = ..., output_fields: Optional[List[str]] = ..., round_decimal: int = ..., ranker: Optional[Union[Function, FunctionScore]] = ..., **kwargs) -> milvus_types.SearchRequest:
        ...
    
    @classmethod
    def hybrid_search_request_with_ranker(cls, collection_name: str, reqs: List, rerank: Union[BaseRanker, Function], limit: int, partition_names: Optional[List[str]] = ..., output_fields: Optional[List[str]] = ..., round_decimal: int = ..., **kwargs) -> milvus_types.HybridSearchRequest:
        ...
    ...
    @classmethod
    def manual_compaction(cls, collection_name: str, is_clustering: bool, is_l0: bool, collection_id: Optional[int] = ...): # -> ManualCompactionRequest:
        ...
    ...
    @classmethod
    def update_replicate_configuration_request(cls, clusters: Optional[List[Dict]] = ..., cross_cluster_topology: Optional[List[Dict]] = ...): # -> UpdateReplicateConfigurationRequest:
        ...
