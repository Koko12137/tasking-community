...
def load_state(collection_name: str, partition_names: Optional[List[str]] = ..., using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
...
def wait_for_loading_complete(collection_name: str, partition_names: Optional[List[str]] = ..., timeout: Optional[float] = ..., using: str = ...): # -> CoroutineType[Any, Any, Any]:
    """
...
def index_building_progress(collection_name: str, index_name: str = ..., using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    """
...
def has_collection(collection_name: str, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    """
...
def drop_collection(collection_name: str, timeout: Optional[float] = ..., using: str = ...): # -> CoroutineType[Any, Any, Any]:
    """
...
def rename_collection(old_collection_name: str, new_collection_name: str, new_db_name: str = ..., timeout: Optional[float] = ..., using: str = ...): # -> CoroutineType[Any, Any, Any]:
    """
...
def load_balance(collection_name: str, src_node_id: int, dst_node_ids: Optional[List[int]] = ..., sealed_segment_ids: Optional[List[int]] = ..., timeout: Optional[float] = ..., using: str = ...): # -> CoroutineType[Any, Any, Any]:
...
def get_query_segment_info(collection_name: str, timeout: Optional[float] = ..., using: str = ...): # -> CoroutineType[Any, Any, Any]:
    """
...
def create_alias(collection_name: str, alias: str, timeout: Optional[float] = ..., using: str = ...): # -> CoroutineType[Any, Any, Any]:
...
def drop_alias(alias: str, timeout: Optional[float] = ..., using: str = ...): # -> CoroutineType[Any, Any, Any]:
    """Delete the alias.
...
def alter_alias(collection_name: str, alias: str, timeout: Optional[float] = ..., using: str = ...): # -> CoroutineType[Any, Any, Any]:
...
def create_user(user: str, password: str, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
...
def update_password(user: str, old_password: str, new_password: str, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    """
...
def delete_user(user: str, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
...
def list_usernames(using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    """List all usernames.
    :return list of str:
...
def list_roles(include_user_info: bool, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    """List All Role Info
...
def list_user(username: str, include_role_info: bool, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    """List One User Info
...
def list_users(include_role_info: bool, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    """List All User Info
...
def create_resource_group(name: str, using: str = ..., timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
...
def update_resource_groups(configs: Mapping[str, ResourceGroupConfig], using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
...
def drop_resource_group(name: str, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
...
def describe_resource_group(name: str, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    """Drop a resource group
        It will success if the resource group is existed and empty, otherwise fail.
...
def list_resource_groups(using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
...
def transfer_node(source_group: str, target_group: str, num_nodes: int, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
...
def transfer_replica(source_group: str, target_group: str, collection_name: str, num_replicas: int, using: str = ..., timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
...
def flush_all(using: str = ..., timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
