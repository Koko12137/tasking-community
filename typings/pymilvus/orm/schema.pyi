...
class CollectionSchema:
    def __init__(self, fields: List, description: str = ..., struct_fields: Optional[List] = ..., functions: Optional[List] = ..., **kwargs) -> None:
        ...
    ...
    @property
    def struct_fields(self): # -> list[Any]:
        ...
    ...
    def add_struct_field(self, struct_field_schema: StructFieldSchema): # -> Self:
        ...
...
class StructFieldSchema:
    ...
    @classmethod
    def construct_from_dict(cls, raw: Dict): # -> Self:
...
class Function:
    def __init__(self, name: str, function_type: FunctionType, input_field_names: Union[str, List[str]], output_field_names: Optional[Union[str, List[str]]] = ..., description: str = ..., params: Optional[Dict] = ...) -> None:
        ...
...
class FunctionScore:
    def __init__(self, functions: Union[Function, List[Function]], params: Optional[Dict] = ...) -> None:
        ...
    
    @property
    def params(self): # -> Dict[Any, Any] | None:
        ...
