...
class Partition:
    ...
    def drop(self, timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
    ...
    def load(self, replica_number: Optional[int] = ..., timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
    ...
    def release(self, timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
    ...
    def hybrid_search(self, reqs: List, rerank: BaseRanker, limit: int, output_fields: Optional[List[str]] = ..., timeout: Optional[float] = ..., round_decimal: int = ..., **kwargs): # -> SearchFuture | SearchResult | CoroutineType[Any, Any, Any]:
    ...
    def query(self, expr: str, output_fields: Optional[List[str]] = ..., timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
