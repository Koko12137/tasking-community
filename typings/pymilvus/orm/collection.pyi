...
from .schema import CollectionSchema, FieldSchema, Function, FunctionScore
...
class Collection:
    ...
    def search(self, data: Union[List, utils.SparseMatrixInputType], anns_field: str, param: Dict, limit: int, expr: Optional[str] = ..., partition_names: Optional[List[str]] = ..., output_fields: Optional[List[str]] = ..., timeout: Optional[float] = ..., round_decimal: int = ..., ranker: Optional[Union[Function, FunctionScore]] = ..., **kwargs): # -> SearchFuture | SearchResult | CoroutineType[Any, Any, Any]:
    ...
    def hybrid_search(self, reqs: List, rerank: BaseRanker, limit: int, partition_names: Optional[List[str]] = ..., output_fields: Optional[List[str]] = ..., timeout: Optional[float] = ..., round_decimal: int = ..., ranker: Optional[Function] = ..., **kwargs): # -> SearchFuture | SearchResult | CoroutineType[Any, Any, Any]:
    ...
    def query(self, expr: str, output_fields: Optional[List[str]] = ..., partition_names: Optional[List[str]] = ..., timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
    ...
    def drop_partition(self, partition_name: str, timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
    ...
    def create_index(self, field_name: str, index_params: Optional[Dict] = ..., timeout: Optional[float] = ..., **kwargs): # -> CoroutineType[Any, Any, Any]:
    ...
    def alter_index(self, index_name: str, extra_params: dict, timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
    ...
    def describe(self, timeout: Optional[float] = ...): # -> CoroutineType[Any, Any, Any]:
        ...
