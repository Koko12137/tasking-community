...
class Role:
    ...
    def create(self): # -> CoroutineType[Any, Any, Any]:
        """Create a role
    ...
    def drop(self): # -> CoroutineType[Any, Any, Any]:
        """Drop a role
    ...
    def add_user(self, username: str): # -> CoroutineType[Any, Any, Any]:
        """Add user to role
    ...
    def remove_user(self, username: str): # -> CoroutineType[Any, Any, Any]:
    ...
    def grant(self, object: str, object_name: str, privilege: str, db_name: str = ...): # -> CoroutineType[Any, Any, Any]:
    ...
    def revoke(self, object: str, object_name: str, privilege: str, db_name: str = ...): # -> CoroutineType[Any, Any, Any]:
    ...
    def grant_v2(self, privilege: str, collection_name: str, db_name: Optional[str] = ...): # -> CoroutineType[Any, Any, Any]:
        """Grant a privilege for the role
            :param privilege: privilege name.
            :type  privilege: str
    ...
    def revoke_v2(self, privilege: str, collection_name: str, db_name: Optional[str] = ...): # -> CoroutineType[Any, Any, Any]:
        """Revoke a privilege for the role
            :param privilege: privilege name.
            :type  privilege: str
            :param collection_name: collection name.
    ...
    def list_grant(self, object: str, object_name: str, db_name: str = ...): # -> CoroutineType[Any, Any, Any]:
    ...
    def list_grants(self, db_name: str = ...): # -> CoroutineType[Any, Any, Any]:
    ...
    def create_privilege_group(self, privilege_group: str): # -> CoroutineType[Any, Any, Any]:
    ...
    def drop_privilege_group(self, privilege_group: str): # -> CoroutineType[Any, Any, Any]:
    ...
    def list_privilege_groups(self): # -> CoroutineType[Any, Any, Any]:
    ...
    def add_privileges_to_group(self, privilege_group: str, privileges: list): # -> CoroutineType[Any, Any, Any]:
    ...
    def remove_privileges_from_group(self, privilege_group: str, privileges: list): # -> CoroutineType[Any, Any, Any]:
