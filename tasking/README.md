...
│   │   ├── 📄 interface.py     # IAgent 接口定义
│   │   ├── 📄 base.py          # 智能体基础实现
│   │   ├── 📄 react.py         # React 模式智能体实现
│   │   ├── 📄 reflect.py       # Reflect 模式智能体实现
│   │   ├── 📄 orchestrate.py   # Orchestrate 模式智能体
│   │   └── 📄 __init__.py
│   ├── 📁 context/             # 上下文管理系统
│   │   ├── 📄 interface.py     # IContextual 接口
│   │   ├── 📄 base.py          # 上下文基础实现
│   │   └── 📄 __init__.py
│   ├── 📁 middleware/          # 中间件系统
...
│   │   └── 📄 __init__.py
│   ├── 📁 scheduler/           # 任务调度系统
│   │   ├── 📄 README.md        # Scheduler 模块详细文档
│   │   ├── 📄 interface.py     # IScheduler 接口
│   │   ├── 📄 base.py          # 基础调度器
│   │   ├── 📄 task.py          # 任务调度器实现
│   │   └── 📄 __init__.py
│   ├── 📁 state_machine/       # 状态机核心
